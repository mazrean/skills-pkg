...
func newSimpleAgent(name string, pathParts ...string) port.AgentProvider {
	return &simpleAgent{name: name, pathParts: pathParts}
}
...
func NewClaudeCode() port.AgentProvider {
	return newSimpleAgent("claude-code", ".claude", "skills")
}
...
func NewUniversal() port.AgentProvider {
	return newSimpleAgent("universal", ".config", "agents", "skills")
}
...
func NewCommandCode() port.AgentProvider {
	return newSimpleAgent("command-code", ".commandcode", "skills")
}
...
func NewContinueAgent() port.AgentProvider {
	return newSimpleAgent("continue", ".continue", "skills")
}
