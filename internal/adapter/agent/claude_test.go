...
// TestClaude_ResolveAgentDir tests directory resolution for Claude agent.
// Requirements: 10.3, 10.4
func TestClaude_ResolveAgentDir(t *testing.T) {
	tests := []struct {
		name            string
		agentName       string
		checkSuffix     string
...
// TestClaude_AgentName tests agent name retrieval.
// Requirements: 10.4
func TestClaude_AgentName(t *testing.T) {
	tests := []struct {
		name string
		want string
	}{
